...
class _SimpleRecorderState extends State<SimpleRecorder> {
  ...
  String _mPath = 'top_note_audio_no ${DateTime.now()}.mp4';
...
// ----------------------------- UI --------------------------------------------
  ...
  Widget build(BuildContext context) {
    print('List of File Paths ${audios}');
    Widget makeBody() {
      return Column(
        children: [
          Container(
            ...
            child: Row(children: [
              ...
              Text(_mRecorder!.isRecording
                  ? 'Recording in progress ${_mPath.length}'
                  : 'Recorder is stopped'),
            ]),
          ),
          Container(
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            '${audios[0].toString().substring(0, 18)}' +
                                {index + 1}.toString(),
                          ),
                          Text(
                            '${_mPath.length}',
